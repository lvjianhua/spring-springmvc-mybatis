	 ...
	 <table>
    	<tr>
    		...
    		<td style="text-align:right">
    			...
    			转到<input type="text" id="gPage" cssStyle="width:20px" name="currentPage"></input><input type="button" value="GO" onclick="jump(document.getElementById('gPage').value,${pager.pageSize})" />
